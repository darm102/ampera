...
<html lang="en">
	<head>
		...
		<link href="<?php echo base_url()?>style/js/jquery-ui-1.12.1/jquery-ui.min.css" rel="stylesheet">
		<link href="<?php echo base_url()?>style/font-awesome/css/font-awesome.min.css" rel="stylesheet">
		<link href='<?php echo base_url()?>style/font/font' rel='stylesheet' type='text/css'>
		<link href="<?php echo base_url()?>style/custom/style_v1.css" rel="stylesheet">
...
<script src="<?php echo base_url()?>style/js/jquery-ui/jquery-ui.min.js"></script>
<!-- Include all compiled plugins (below), or include individual files as needed -->
<script src="<?php echo base_url()?>style/bootstrap/js/bootstrap.min.js"></script>
<script src="<?php echo base_url()?>style/tinymce/js/tinymce/tinymce.min.js"></script>
<script src="<?php echo base_url()?>style/tinymce/js/tinymce/jquery.tinymce.min.js"></script>
</body>
</html>
